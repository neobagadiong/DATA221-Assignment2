...
studentStatsDataFrame['grade_band'] = numpy.select([(studentStatsDataFrame['grade'] >= 15),(studentStatsDataFrame['grade'] >= 10),(studentStatsDataFrame['grade'] < 10)],['High','Medium','Low'])
...
#print(len(studentStatsDataFrame[studentStatsDataFrame['grade_band'] == 'Medium'].index))
...
print(studentStatsSummaryDataFrame)